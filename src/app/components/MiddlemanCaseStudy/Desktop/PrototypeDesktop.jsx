        ...
        <div className='flex flex-col-reverse items-center gap-y-6 gap-x-40 md:grid md:grid-cols-2'>
            <div className='flex justify-end md:pr-20'>
                <div className='flex flex-col justify-around'>
                    ...
                    <Link href={pd}><button className='bg-white hover:bg-grey-hold hover:text-white text-black w-64 h-16 rounded-full text-xl mt-6'>View hi-fi prototype</button></Link>
                </div>
            </div>
